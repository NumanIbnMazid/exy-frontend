<template>
    <div class="tab-content ms-3 me-3 mb-4 cocoro-section-tab-content" id="pills-tabContent">
                            ...
                            <!-- *** Tab 1 *** -->
                            <div class="tab-pane fade pills-experienced-based" id="pills-experienced-based" role="tabpanel" aria-labelledby="pills-experienced-based-tab">
                                <div class="tab-content-holder">
                                    ...
                                    <!-- section 2 -->
                                    <!-- User Registration -->
                                    <user-registration :showRegType="showRegType" :activeTab="activeTab"></user-registration>
                                    <!-- /section 2 -->
                                    ...
                                    <!-- section 8 -->
                                    <!-- Total Fee -->
                                    <total-fee :gardenChecked="gardenChecked" :reservationPre="reservationPre"></total-fee>
                                    <!-- /section 8 -->
                            ...
                            <!-- *** Tab 2 *** -->
                            <div class="tab-pane fade show active pills-monthly-childcare" id="pills-monthly-childcare" role="tabpanel" aria-labelledby="pills-monthly-childcare-tab">
                                <div class="tab-content-holder">
                                    <!-- section 1 -->
                                    <section class="p-5 bg-light">
