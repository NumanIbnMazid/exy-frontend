      ...
      <div class="row w-100 mt-5 me-0 ms-0">
        ...
        <div class="col-md-9 right-col">
            ...
            <div v-if="activeTab===2" class="row">
                 <div class="col-md-12">
                    <div class="row  row-8 row-border-1 mt-4 py-4 text-base">
                      <p class="text-center text-lg"> <span class="span-1 px-3 py-2 fw-bold me-1 text-xl">!</span> 予約が【確定】しました。園からの連絡事項をご一読のうえ、ご指定の日時に保育園へご来園ください。</p>
                      <p class="m-0 text-center">※ご連絡のないキャンセルをされた場合、今後ご予約を承れなくなることがあります。</p>
                    </div>
