                                    ...
                                    <div class="col-md-12 inner-col">
                                        <div class="row box-row-1 no-border">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 text-center pt-1">利用開始日時</p>
                                            </div>
                                        ...
                                        <div class="row box-row-1">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 text-center pt-1">利用終了日時</p>
                                            </div>
                                            <div class="col-md-10 box-right py-2 ps-4">
                                        ...
                                        <div class="row box-row-1">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 pt-1"><input type="checkbox"> <span class="ps-3">利用内容</span></p>
                                            </div>
                                            <div class="col-md-10 box-right py-2 ps-4">
                                                <p class="m-0">体験保育</p>
                                            </div>
                                        ...
                                        <div class="row box-row-1">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 pt-1"><input type="checkbox"> <span class="ps-3">料金プラン</span></p>
                                            </div>
                                            <div class="col-md-10 box-right py-2 ps-4">
                                        ...
                                        <div class="row box-row-1">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 pt-1"><input type="checkbox"> <span class="ps-3">オプション</span></p>
                                            </div>
                                            <div class="col-md-10 box-right py-2 ps-4">
                                        ...
                                        <div class="row box-row-1">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 pt-1"><input type="checkbox"> <span class="ps-3">支払い方法</span></p>
                                            </div>
                                            <div class="col-md-10 box-right py-2 ps-4">
                                        ...
                                        <div class="row box-row-1">
                                            <div class="col-md-2 box-left py-2 text-sm">
                                                <p class="m-0 text-center pt-1">完了報告</p>
                                            </div>
